...
public class IllinoisVerbSRLServer {
    private static Logger logger = LoggerFactory.getLogger(IllinoisVerbSRLServer.class);
	...
	try {
	    ...
	    hformat.printHelp("java " + IllinoisVerbSRLServer.class.getName(),
			      options, true);
	    System.exit(1);
	}
	...
	IllinoisSRLServer server = new IllinoisSRLServer(VerbSRLSystem.getInstance(), true);
