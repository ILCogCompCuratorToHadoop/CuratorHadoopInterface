...
CMD="java -cp $CLASSPATH -Dhome=$CURATOR_BASE -Xmx10G edu.illinois.cs.cogcomp.annotation.server.IllinoisNomSRLServer -c $CONFIGDIR/srl-config.properties  $@"
